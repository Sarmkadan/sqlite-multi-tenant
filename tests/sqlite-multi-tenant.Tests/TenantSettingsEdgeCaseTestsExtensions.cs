...
/// <summary>
/// Extension methods for TenantSettingsEdgeCaseTests providing utility methods for testing
/// type conversions, validation scenarios, and edge cases.
/// </summary>
public static class TenantSettingsEdgeCaseTestsExtensions
{
    /// <summary>
    /// Creates a test TenantSettings instance with default valid values.
    /// </summary>
    ...
    /// <summary>
    /// Creates a test TenantSettings instance with the specified data type.
    /// </summary>
    /// <param name="dataType">The data type name (e.g., "Int32", "Boolean", "String")</param>
    /// <param name="settingValue">The setting value to use</param>
    /// <returns>A new TenantSettings instance with the specified data type</returns>
    ...
    /// <returns>A new TenantSettings instance with the numeric value set</returns>
    ...
    /// <returns>List of TenantSettings instances</returns>
    ...
    /// <param name="modifiedBy">The user who modified the setting</param>
    /// <returns>A new TenantSettings instance with the boolean value set</returns>
