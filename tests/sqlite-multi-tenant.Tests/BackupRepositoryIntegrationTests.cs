...
{
/// <summary>
/// Integration tests for <see cref="BackupRepository"/> that verify database operations against a real SQLite database.
/// </summary>
public sealed class BackupRepositoryIntegrationTests : IDisposable
{
    /// <summary>
    /// Path to the temporary SQLite database file used for testing.
    /// </summary>
    private readonly string _dbPath;

    /// <summary>
    /// Connection string for the test SQLite database.
    /// </summary>
    private readonly string _connectionString;

    /// <summary>
    /// Instance of <see cref="BackupRepository"/> used for testing database operations.
    /// </summary>
    private readonly BackupRepository _backupRepository;

    /// <summary>
    /// Initializes a new instance of the <see cref="BackupRepositoryIntegrationTests"/> class.
    /// Sets up a temporary SQLite database and seeds it with test data.
    /// </summary>
    ...
    /// <summary>
    /// Seeds the test database with initial backup records for testing purposes.
    /// Creates three test backups with different statuses and expiration dates.
    /// </summary>
    ...
    /// <summary>
    /// Helper method to insert a test backup record into the database.
    /// </summary>
    /// <param name="connection">The SQLite database connection.</param>
    /// <param name="backupId">The unique identifier for the backup.</param>
    /// <param name="databaseId">The identifier of the database being backed up.</param>
    /// <param name="backupPath">The file path where the backup is stored.</param>
    /// <param name="status">The status of the backup operation.</param>
    /// <param name="createdAt">The creation timestamp of the backup.</param>
    /// <param name="expiresAt">The expiration timestamp of the backup.</param>
