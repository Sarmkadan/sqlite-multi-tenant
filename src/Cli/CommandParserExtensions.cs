    ...
    public static class CommandParserExtensions
    {
            ...
            CommandHandler commandHandler)
        {
            ...
            var subcommand = commandHandler.Subcommands?
                .FirstOrDefault(s => s.Name.Equals(parsedCommand.Subcommand, StringComparison.OrdinalIgnoreCase));
            ...
            string subcommandName)
        {
            ...
            return commandHandler.Subcommands?
                .Any(s => s.Name.Equals(subcommandName, StringComparison.OrdinalIgnoreCase)) 
                ?? false;
        }
